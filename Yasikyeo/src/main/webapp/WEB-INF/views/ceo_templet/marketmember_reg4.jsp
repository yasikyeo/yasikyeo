							...
							<form id="shop_reg">
								<table border="3"; width="100%"; height="100%";>
									...
									<tr>
										...
										<td class="td_2"><input type="text" class="formInput" name="shop_name"></td>
									</tr>
									
									<tr>
										<td class="td_1">업소이미지</td>
										<td class="td_2"><input type="file" class="formInput2" name="shop_image"></td>
									</tr>
									
									<tr>
										<td class="td_1">업소소개</td>
										<td class="td_2"><input type="text" class="formInput" name="shop_explain"></td>
									</tr>
									
									<tr>
										<td class="td_1">최소배달금액</td>
										<td class="td_2"><input type="text" class="formInput" name="shop_minprice"></td>
									</tr>
									
									<tr>
										<td class="td_1">오픈 & 마감시간</td>
										<td class="td_2">
											<select name="shop_opentime" class="formInput3">
											...
											<select name="shop_closetime" class="formInput3">
												<option value="am">오전</option>
												<option value="pm">오후</option>
											</select>
									...
									<tr>
										...
										<td class="td_2"><input type="text" class="formInput" name="shop_tel"></td>
									</tr>
									
									<tr>
										<td class="td_1">배달여부</td>
										<td class="td_2">
											<input type="radio" class="formInput" name="shop_delivery" value="true">가능
											<input type="radio" class="formInput" name="shop_delivery" value="false">불가
										</td>
									</tr>
									
									<tr>
										<td class="td_1">원산지내용</td>
										<td class="td_2"><input type="text" class="formInput" name="shop_origin"></td>
									</tr>
									...
									<tr>
										...
										<td class="td_2">
											<a href="javascript:void(0);" onclick="window.open('daummap.do', '_blank', 'width=1080px, height=680px')">
												<input type="button" value="지도창 띄우기">
											</a>
										</td>
									</tr>
									...
									<tr>
										...
										<td class="td_2">
											...
											<input type="text" class="formInput" name="shop_account"></td>
									</tr>
								</table>	
							</form>
							<div id="buttonset">	
