						...
						<div id="ceo_notice">
							<table>
								...
								<tr>
									...
									<td id="t_cus2">
										<div class="product clear">
											<details> <summary>[공지] 배달의민족 9월 시스템 정기점검
											안내</summary>
											<div id="content">
												...
												<br> 목요일 오전 04시 ~ 08시 30분 (4시간30분) 관련하여 궁금하신 사항은 배달의민족<br>
								...
								<tr>
									...
									<td id="t_cus2">
										<div class="product clear">
											...
											<div id="content">
												안녕하세요. 야시켜입니다. <br> <br> 이제 배달의민족에서 야시켜와 함께 주류를
									...
									<td id="t_cus2">
										<div class="product clear">
											...
											<div id="content">
												...
												앞으로도 사장님들께 더 나은 배달의민족 서비스를 드릴 수 있도록 최선을 다하겠습니다. <br><br>
