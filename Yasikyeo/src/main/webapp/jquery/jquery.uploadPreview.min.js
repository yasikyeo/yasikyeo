        ...
        if (typeof($(settings.input_field)) !== 'undefined' && $(settings.input_field) !== null) {
          $(settings.input_field).change(function() {
            ...
            if (files.length > 0) {
              ...
              // Clear background             
              $(settings.preview_box).css("background-image", "url('"+getContextPath()+"/images/"+(settings.preview_default)+"')");
              $(settings.preview_box).css("background-size", "inherit");
